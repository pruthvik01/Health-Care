...
<input type="text" name="patname" class="form-control"  value="<?php  echo $row['PatientName'];?>" required="true" autocomplete="off">
</div>
<div class="form-group">
<label for="fess">
 Patient Contact no
</label>
<input type="text" name="patcontact" class="form-control"  value="<?php  echo $row['PatientContno'];?>" required="true" maxlength="10" pattern="[0-9]+" autocomplete="off">
</div>
<div class="form-group">
<label for="fess">
Patient Email
...
<input type="text" name="patage" class="form-control"  value="<?php  echo $row['PatientAge'];?>" required="true" autocomplete="off">
</div>
<div class="form-group">
<label for="fess">
 Medical History
...
<input type="text" class="form-control"  value="<?php  echo $row['CreationDate'];?>" readonly='true' autocomplete="off">
</div>
<?php } ?>
