											...
											<div class="panel-body">
												...
												<form role="form" name="dcotorspcl" method="post">
													<div class="form-group">
														...
														<input type="text" name="doctorspecilization" class="form-control" placeholder="Enter Doctor Specialization" autocomplete="off">
													</div>
									...
									<tbody>
										...
										?>
											...
											<tr>
												...
												<td><?php
													if ($row['updationDate'] == '0000-00-00 00:00:00') {
