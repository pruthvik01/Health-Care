								...
								<table class="table table-hover" id="sample-table-1">
									<thead>
										<tr>
											...
											<th>Appointment Meeting Link </th>
											<th>Password </th>
										...
										?>
											...
											<tr>
												...
												<?php if($row['userStatus'] == 0 || $row['doctorStatus'] == 0){ ?>
													<a href="javascript:void(0)"><img src="./assets/images/zoom1.png" alt="zoom" style="width:35px ;"></a>
												<?php }else{ ?>
													<a href="<?php echo $row['join_url'] ?>" target="_blank"><img src="./assets/images/zoom1.png" alt="zoom" style="width:35px ;"></a>
												<?php } ?>
												</td>
